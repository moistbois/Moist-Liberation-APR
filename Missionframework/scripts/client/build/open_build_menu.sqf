        ...
        lbClear 110;
        {
            ...
            if (buildtype != 8) then {
                ...
                switch (_classnamevar) do {
                    ...
                    case (KPLIB_b_mobileRespawn select 0): {if (KPLIB_param_mobileRespawn) then {_entrytext = localize "STR_RESPAWN_TRUCK";};};
					case (KPLIB_b_mobileRespawn select 1): {if (KPLIB_param_mobileRespawn) then {_entrytext = localize "STR_RESPAWN_TRUCK";};};
