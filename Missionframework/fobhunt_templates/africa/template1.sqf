private _objects_to_build = [
    ...
    ["Land_HBarrierBig_F",[-4,-30,0],0],
    ["Land_HBarrierBig_F",[-11,-30,0],0],
    ["Land_Cargo_Patrol_V2_F",[-10,-26,0],0],
    ["Land_Cargo_HQ_V2_F",[4,-20,0],0],
    ["Land_Cargo_House_V2_F",[-9,24,0],0],
    ["Land_Cargo_House_V2_F",[-1,24,0],0],
    ["Land_Cargo_Patrol_V2_F",[10,24,0],180],
