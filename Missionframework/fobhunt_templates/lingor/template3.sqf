private _objects_to_build = [
    ...
    ["Land_GameProofFence_01_l_5m_F", [-3.10, 15.42, 0.00], 0.00],
    ["Land_vn_t_palaquium_f", [-12.29, 3.13, 0.00], 95.83],
    ["Land_vn_fence_wooden_01_10", [15.66, 3.03, 0.00], 61.75],
    ["Land_vn_o_snipertree_02", [13.26, -6.76, 0.00], 258.65],
    ["Land_vn_t_cyathea_f", [1.14, 17.25, 0.00], 0.00],
    ["Land_vn_fence_wooden_01_03", [-11.63, 13.38, 0.00], 146.40],
    ...
    ["Land_GameProofFence_01_l_5m_F", [18.41, -12.07, 0.00], 104.22],
    ["Land_vn_o_bunker_03", [-17.76, -15.86, 0.00], 236.35],
    ["Land_vn_t_palaquium_f", [-8.72, -19.05, 0.00], 210.99],
    ["Land_vn_fence_wooden_01_03", [-22.95, 3.14, 0.00], 280.26],
    ["Land_vn_fence_wooden_01_10", [5.78, -22.92, 0.00], 166.17],
    ["Land_vn_fence_wooden_01_03", [-22.14, -8.48, 0.00], 242.52],
    ["Land_GameProofFence_01_l_5m_F", [-9.35, -22.27, 0.00], 205.31],
...
private _objectives_to_build = [
    ...
    [KPLIB_o_ammoTruck, [0.44, -4.42, 0.00], 17.81]
];
private _defenders_to_build = [
    [KPLIB_o_rifleman, [-3.89, 0.85, 0.00], 210.66],
    [KPLIB_o_engineer, [4.16, -4.55, 0.00], 0.00],
    [KPLIB_o_rifleman, [-7.85, -1.04, 0.00], 99.18],
    [KPLIB_o_medic, [5.31, 13.03, 0.25], 303.40],
    [KPLIB_o_marksman, [13.25, -6.67, 10.16], 109.01],
    [KPLIB_o_heavyGunner, [-18.88, 8.63, 0.15], 330.14],
    [KPLIB_o_rifleman, [-17.60, -16.01, 0.14], 228.17],
    [KPLIB_o_rifleman, [13.99, -20.32, 0.15], 157.66]
];
