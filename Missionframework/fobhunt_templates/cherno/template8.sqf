private _objects_to_build = [
    ...
    ["Land_Workshop_01_grey_F", [6.05, 17.88, 0.00], 0.00],
    ["Land_Strazni_vez", [-18.68, 18.47, 0.00], 180.00],
    ["Land_Strazni_vez", [23.76, -10.91, 0.00], 270.00],
    ["Land_ControlTower_01_F", [-4.99, -5.71, 0.00], 180.00],
