private _objects_to_build = [
    ...
    ["Land_HBarrierBig_F",[-4,-30,0],0],
    ["Land_HBarrierBig_F",[-11,-30,0],0],
    ["Land_Strazni_vez",[-10,-26,0],0],
    ["Land_GuardHouse_02_grey_F",[4,-20,0],0],
    ["Land_Workshop_01_grey_F",[-9,24,0],0],
    ["Land_Workshop_01_grey_F",[-1,24,0],0],
    ["Land_Strazni_vez",[10,24,0],180],
