...
private _objects_to_build = [
    ...
    [ "CamoNet_wdl_open_F", [-1.91, 5.06, 0], 0 ],
    ...
    [ "Land_Strazni_vez", [15.5, -0.02, 0], 178.97 ],
    [ "Land_Strazni_vez", [-17.12, -0.35, 0], 179.97 ],
    [ "CamoNet_wdl_open_F", [13.71, -11.54, 0], 270.25 ],
    [ "Land_HBarrierBig_F", [16.94, 5.18, 0], 181.2 ],
    [ "Land_Workshop_01_grey_F", [-16.03, -9.69, 0], 269.88 ],
    [ KPLIB_o_transportTruck, [-10.4, 14.9, -0.02], 181.03 ],
    [ "Land_HBarrierBig_F", [-17.6, 5.28, 0], 359.67 ],
    [ "Land_GuardHouse_02_grey_F", [11.25, 14.59, 0], 89.97 ],
